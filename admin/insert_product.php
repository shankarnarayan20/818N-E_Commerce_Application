...
if (isset($_POST['insert_product'])) {
    ...
    if ($product_title == '' || $product_description == '' || $product_keywords == '' || $product_category == '' || $product_brand == '' || empty($product_price) || empty($product_image_one) || empty($product_image_two) || empty($product_image_three)) {
        ...
        //move folders
        uploadToS3("Product", $product_image_one, $temp_image_one);
        uploadToS3("Product", $product_image_two, $temp_image_two);
        uploadToS3("Product", $product_image_three, $temp_image_three);
        //insert query in db
